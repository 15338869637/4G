<template>
  <div class="on-site-vehicles flex-box column">
        ...
        <div class="query">
            <div class="condition">
                ...
                <div class="condition-con">
                    <el-select v-model="form.ParkingCode" class="w-input" placeholder="请选择">
                      <el-option
            ...
            <div class="condition">
                <div class="condition-tit">黑名单类型:</div>
                <div class="condition-con">
    ...
    <div class="main flex1 flex-box column">
      <Title titleMsg="黑名单车辆">
        <el-button slot="right" type="primary" class="rightBtn" @click="blInfo">新增黑名单车辆</el-button>
      </Title>
...
export default {
  ...
  methods: {
    ...
    blInfo () {
      ...
      !this.options.DrivewayGuid && GetDriveWayList({ParkingCode: this.bl.ParkingCode}).then(res => {
        if (res) {
          this.options.DrivewayGuid = res || []
        }
      })
      this.dialog = true
    },

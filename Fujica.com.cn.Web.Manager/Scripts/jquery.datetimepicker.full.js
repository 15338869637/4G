...
(function () {
  ...
  _lpad = function (value, length, char) {
    var chr = char || '0'; var val = value.toString()
  ...
  DateFormatter.prototype = {
    ...
    guessDate: function (vDateStr, vFormat) {
      ...
      var self = this; var vParts = vDateStr.replace(self.separators, '\0').split('\0'); var vPattern = /^[djmn]/g

      var vFormatParts = vFormat.match(self.validParts); var vDate = new Date(); var vDigit = 0; var vYear; var i; var iPart; var iSec
    ...
    parseFormat: function (vChar, vDate) {
      var self = this; var vSettings = self.dateSettings; var fmt; var backspace = /\\?(.?)/gi; var doFormat = function (t, s) {
    ...
    formatDate: function (vDate, vFormat) {
      var self = this; var i; var n; var len; var str; var vChar; var vDateStr = ''
      if (typeof vDate === 'string') {
...
;(function (factory) {
  ...
  $.fn.datetimepicker = function (opt, opt2) {
    ...
    createDateTimePicker = function (input) {
      ...
      var mounth_picker = $('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button>' +
        ...
        .on('xchange.xdsoft', function (event) {
          ...
          xchangeTimer = setTimeout(function () {
            ...
            line_time = function line_time (h, m) {
              var now = _xdsoft_datetime.now(); var optionDateTime; var current_time

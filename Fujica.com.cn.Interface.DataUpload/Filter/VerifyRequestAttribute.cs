...
using Fujica.com.cn.Interface.DataUpload.Controllers;
...
namespace Fujica.com.cn.Interface.DataUpload.Filter
{
    /// <summary>
    /// 签名验证 以及请求过程记录
    /// </summary>
    ...
    {
        private const string m_projectInfo = "Fujica.com.cn.Interface.DataUpload.Filters.VerifyRequestAttribute";
                ...
                if (!actionContext.ModelState.IsValid)
                {
                    ...
                    foreach (var key in Keys)
                    {
                        ...
                        foreach (var error in errors)
                        {
                            ...
                            {
                                values.Add(string.Concat(num, ".", error.ErrorMessage));
                                num++;
                            }
                        }
                    }

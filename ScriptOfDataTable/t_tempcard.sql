...
Date: 2019-07-24 13:03:43
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for t_tempcard
-- ----------------------------
DROP TABLE IF EXISTS `t_tempcard`;
CREATE TABLE `t_tempcard` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `identifyinUnique` (`identifying`),
  KEY `moreNormal` (`projectGuid`,`parkCode`,`carOwnerName`,`mobile`,`startDate`,`locked`,`carNo`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=103472 DEFAULT CHARSET=utf8;
